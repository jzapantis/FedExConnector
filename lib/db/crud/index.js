...
exports.create = function (insertDocs, collection, dbResponse) {
...
exports.delete = function (doc, dbResponse) {
  ...
  dbDef(function (err, db) {
    db.collection('ORDERS_MASTER', {}, function (err, collection) {
      if (err) {
        ...
        collection.remove({trackingNumber: doc}, function (err, result) {
          if (err) {
            console.log(err);
            dbResponse(err, null);
          } else {
